...
static void
action_show_hide_preview_panel_callback (GtkAction *action,
                                         gpointer user_data)
{
    NemoWindow *window;
    ...
    if (!NEMO_IS_DESKTOP_WINDOW (user_data)) {
        ...
        nemo_window_set_show_preview_panel (window,
...
static const GtkToggleActionEntry main_toggle_entries[] = {
  ...
  /* is_active */            TRUE },
  /* name, stock id */     { "Show Hide Preview Panel", NULL,
  /* label, accelerator */   N_("_Preview Pane"), "<Alt>P",
  /* tooltip */              N_("Show a preview of the selected file in the right panel"),
                             G_CALLBACK (action_show_hide_preview_panel_callback),
  /* is_active */            FALSE },
